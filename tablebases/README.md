...
piece is generated by a separate uncapped observation-game solver under the
documented [`fresh-maximal-public-view-v1`](../docs/benchmarks/ultimate-information-tablebases.md)
convention. Concrete tables remain its exact transition/value oracle rather
than being treated as public-information results directly.
