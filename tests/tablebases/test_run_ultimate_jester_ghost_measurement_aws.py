...
measure = load(
    "jg_measure", ROOT / "tools/tablebases/run_ultimate_jester_ghost_measurement_aws.py")
certify = load(
    "jg_merge_certify",
    ROOT / "tools/tablebases/certify_ultimate_jester_ghost_merge_aws.py")
...
class JesterGhostMeasurementTest(unittest.TestCase):
    ...
    def test_production_unit_is_measurement_only_and_resource_bounded(self):
        unit = (ROOT / "tools/tablebases/ultimatefish-jg7328-measure-v3.service").read_text()
