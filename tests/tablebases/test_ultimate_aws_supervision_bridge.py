...
BRIDGE = module("bridge", ROOT / "tools/tablebases/ultimate_aws_supervision_bridge.py")
INSTALLER = module(
    "installer", ROOT / "tools/tablebases/install_ultimate_aws_supervision_launchd.py")
