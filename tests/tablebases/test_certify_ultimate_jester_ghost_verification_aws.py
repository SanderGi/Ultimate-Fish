...
audit = load("jg_audit", ROOT / "tools/tablebases/certify_ultimate_jester_ghost_verification_aws.py")
verify = load("jg_verify", ROOT / "tools/tablebases/verify_ultimate_jester_ghost_rebound_aws.py")
...
class CertificationTest(unittest.TestCase):
    def fixture(self, root: Path) -> argparse.Namespace:
        ...
        verifier.write_bytes((
            ROOT / "tools/tablebases/verify_ultimate_jester_ghost_rebound_aws.py").read_bytes())
        ...
        audit_source.write_bytes((
            ROOT / "tools/tablebases/certify_ultimate_jester_ghost_verification_aws.py").read_bytes())
