/* Ultimate Fish exact opposed Ghost/Ghost arbitrary-belief sidecar. GPLv3+. */

#ifndef ULTIMATE_OPPOSED_GHOST_PAIR_INFORMATION_SIDECAR_H_INCLUDED
#define ULTIMATE_OPPOSED_GHOST_PAIR_INFORMATION_SIDECAR_H_INCLUDED
