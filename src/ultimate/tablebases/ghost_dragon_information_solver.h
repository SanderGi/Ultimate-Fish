/* Ultimate Fish exact Dragon/Ghost public-information solver. GPLv3+. */

#ifndef ULTIMATE_GHOST_DRAGON_INFORMATION_SOLVER_H_INCLUDED
#define ULTIMATE_GHOST_DRAGON_INFORMATION_SOLVER_H_INCLUDED
