...
| CopyCat pair movement, capture, death, Ghost and Angel interactions | yes | yes | fixture/self-play | The app's duplicate death callbacks are journaled but deduplicated semantically. |
