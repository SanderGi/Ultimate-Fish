...
BUILD_INPUTS_COMMON = (
    "src/ultimate/ghost_giant_information_tablebase.cpp",
    "src/ultimate/ghost_giant_information_solver.cpp",
    "src/ultimate/ghost_giant_information_solver.h",
    "src/ultimate/ghost_giant_information_model.cpp",
    "src/ultimate/ghost_giant_information_model.h",
    ...
    "tools/run_ultimate_ghost_giant_aws.py",
)
TEXTUAL_CPP = {
    "src/ultimate/ghost_public_extra_information_solver.cpp",
    "src/ultimate/ghost_extra_information_tablebase.cpp",
