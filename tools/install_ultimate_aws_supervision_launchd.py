...
STAGED_FILES = (
    "tools/supervise_ultimate_aws.py",
    "tools/ultimate_aws_supervision.json",
    "tools/ultimate_aws_supervision_bridge.py",
)
...
def launch_agent(staged: Path, python: Path) -> dict[str, object]:
    return {
        ...
        "ProgramArguments": [
            str(python),
            str(staged / "tools/ultimate_aws_supervision_bridge.py"),
