...
BUILD_INPUTS_COMMON = (
    "src/ultimate/ghost_fisherman_information_tablebase.cpp",
    "src/ultimate/ghost_fisherman_information_solver.cpp",
    "src/ultimate/ghost_fisherman_information_solver.h",
