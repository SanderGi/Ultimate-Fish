#!/usr/bin/env python3
"""Build the phase-advised independently bounded Devil v20 source bundle."""
...
base.SCHEMA = "ultimate-devil-spawned-solver-source-v20"
base.SEMANTICS = (
    ...
    "independent-fail-closed-hash-capacity-phase-advised-key-io-v20"
)
