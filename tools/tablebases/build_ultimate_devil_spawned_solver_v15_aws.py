#!/usr/bin/env python3
"""Build, preserve, and restore-check the compact Devil v15 binary."""
...
SOURCE_SHA256 = "34aa7f01b115b277e44388f4772db86e4d614f061481a5a71fafe9157d310353"
SOURCE_VERSION = "Kt08kEfUozr44XUQaOA.H70ozmEVoCJF"
SOURCE_KEY = (
    f"sources/bundles/devil-spawned-solver-v15/sha256/{SOURCE_SHA256}/"
    "ultimatefish-devil-spawned-solver-v15-source.tar"
)
SEMANTICS = (
...
def build(instance: str) -> str:
    ...
    commands = [
        ...
        compile_command,
        "migration_test=$(mktemp -d /mnt/ultimatefish/devil-v15-test.XXXXXX)",
        ...
        "binary_key=sources/binaries/devil-spawned-solver-v15/sha256/"
        "$binary_sha/ultimate_tablebase-devil-spawned-v15",
