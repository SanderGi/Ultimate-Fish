#!/usr/bin/env python3
"""Build, version-preserve, and restore-check the Devil companion v8 binary."""
...
def build(instance: str) -> str:
    ...
    commands = [
        ...
        "binary_key=sources/binaries/devil-spawned-solver-v8/sha256/"
        "$binary_sha/ultimate_tablebase-devil-spawned-v8",
