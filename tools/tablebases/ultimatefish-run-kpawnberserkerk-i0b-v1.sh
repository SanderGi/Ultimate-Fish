#!/usr/bin/env bash
# Generate and preserve same-team K+Pawn+Berserker-v-K from exact dependencies.
set -euo pipefail

bucket=ultimatefish-info-20260808-a4e679c6-831688117652
root=/mnt/ultimatefish-jg/pawn-berserker-same-v1
...
exec /usr/bin/python3 \
  ...
  --workers 8 \
  --s3-prefix results/current-concrete-d64b5cdf/pawn-berserker-same-v1
