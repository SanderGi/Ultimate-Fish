#!/usr/bin/env python3
"""Build, preserve, and restore-check the bit-packed Devil v10 binary."""
...
SOURCE_SHA256 = "9ca2ead4f41ca24b32e028ee5529d43823f695f632158df4039224e9056b5fc1"
SOURCE_VERSION = "Xbg1eQwumBpQ2qHO1S5dJSjI8O8lKrOn"
SOURCE_KEY = (
    f"sources/bundles/devil-spawned-solver-v10/sha256/{SOURCE_SHA256}/"
...
def build(instance: str) -> str:
    root = f"/mnt/ultimatefish/devil-spawned-solver-v10-{SOURCE_SHA256[:8]}"
    source = f"{root}/source.tar"
    tree = f"{root}/source"
    binary = f"{root}/ultimate_tablebase-devil-spawned-v10"
    compile_command = (
    ...
    commands = [
        ...
        "binary_key=sources/binaries/devil-spawned-solver-v10/sha256/"
        "$binary_sha/ultimate_tablebase-devil-spawned-v10",
