...
# 30-worker fixed point. The immutable transition graph is reused verbatim.
set -euo pipefail
...
readonly runner="${source}/tools/tablebases/run_ultimate_ghost_pair_current_aws.py"
...
test "$(sha256sum "${runner}" | cut -d ' ' -f 1)" = \
  bd2afad8c009158d27dd6b66225e59d8a4c4b199401e173ad28faee598703b12
