#!/usr/bin/env python3
"""Resume authenticated B1 from persistent gp3 with the scaled v27 binary."""
...
impl.impl.WORK_ROOT = "/mnt/checkpoint-migrate/resize-i024-v1/payload-4"
impl.impl.VOLUME = "/mnt/checkpoint-migrate"
impl.impl.MEMORY_MAX = 450_000_000_000
impl.impl.base.ROOT = (
    "/mnt/checkpoint-migrate/devil-spawned-solver-v28-"
...
def names(piece: str, opposed: bool, square: int,
    ...
    unit = f"ultimatefish-devil-companion-v28-{orientation}-{piece}-square-{square}"
    log = f"{work}/devil-{square}.v28.log"
