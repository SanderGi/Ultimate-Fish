#!/usr/bin/env python3
"""Build, preserve, and restore-check the phase-advised Devil v21 binary."""
...
SEMANTICS = (
    ...
    "90-percent-load-independent-fail-closed-hash-capacity-"
    "six-bit-phase-advised-key-io-v21"
)
...
def build(instance: str) -> str:
    ...
    commands = [
        ...
        "reverse_test=$(mktemp -d /mnt/ultimatefish/devil-v21-reverse.XXXXXX)",
        "migration_test=$(mktemp -d /mnt/ultimatefish/devil-v21-migrate.XXXXXX)",
        ...
        "binary_key=sources/binaries/devil-spawned-solver-v21/sha256/"
        "$binary_sha/ultimate_tablebase-devil-spawned-v21",
        ...
        "restore=$(mktemp /mnt/ultimatefish/devil-v21-binary.XXXXXX)",
        ...
        "\"$binary_sha\"",
        "printf '%s\\n' DEVIL_V21_BINARY_PRESERVED sha256=\"$binary_sha\" "
