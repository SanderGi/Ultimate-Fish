...
readonly scratch=${root}/work/solve-current-v38/kghostkchecker
readonly old_log=${root}/work/logs/compositional-merge-solve-v4.log
readonly log=${root}/work/logs/checker-current-v38.log
readonly output=${root}/work/results/kghostkchecker-current-v38.ufiw
readonly arbitrary=${root}/work/results/kghostkchecker-current-v38.ufgd
...
exec >>"${log}" 2>&1
echo "checker_opposed_current_v38 source_sha256=${source_sha} normalized_sha256=${normalized_sha} retained_zero_change_iteration=26 workers=32"
...
echo 'checker_opposed_current_v38 complete 1'
