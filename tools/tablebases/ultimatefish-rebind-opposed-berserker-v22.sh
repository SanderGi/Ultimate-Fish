...
readonly log=${root}/work/logs/rebind-v22.log
...
exec >>"${log}" 2>&1
echo 'berserker_ghost_opposed_rebind_v22 begin 1'
cd "${root}"
"${binary}" --rebind-transitions \
...
echo 'berserker_ghost_opposed_rebind_v22 complete 1 residual 0'
