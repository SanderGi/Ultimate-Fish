...
work=/mnt/ultimatefish/info-remap-fix-v2/kcopycatkghost-fresh-v1
source_table=/mnt/ultimatefish/info-wave-aa82210e-work/kcopycatkghost/tablebases/kcopycatkghost.uftb
lower_table=/mnt/ultimatefish/info-wave-aa82210e-work/kcopycatkghost/tablebases/kcopycatk.uftb
...
test "$(sha256sum "${source_table}" | cut -d ' ' -f 1)" = 24236242cb82f0158d827daeaf0762dee9d551532feaaaedc891bbe8576efe50
test "$(sha256sum "${lower_table}" | cut -d ' ' -f 1)" = 98dbd354da959fa923ed9b712c1bde7147f2039a9bcf50306cbdc2a9b3098aeb
test "$(df --output=avail -B1 /mnt/ultimatefish | tail -1)" -ge 536870912000
