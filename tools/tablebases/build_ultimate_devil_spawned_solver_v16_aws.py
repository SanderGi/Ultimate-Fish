#!/usr/bin/env python3
"""Build, preserve, and restore-check the compact-hash Devil v16 binary."""
...
def build(instance: str) -> str:
    ...
    commands = [
        ...
        compile_command,
        "reverse_test=$(mktemp -d /mnt/ultimatefish/devil-v16-reverse.XXXXXX)",
        "migration_test=$(mktemp -d /mnt/ultimatefish/devil-v16-migrate.XXXXXX)",
        ...
        "binary_key=sources/binaries/devil-spawned-solver-v16/sha256/"
        "$binary_sha/ultimate_tablebase-devil-spawned-v16",
        ...
        "restore=$(mktemp /mnt/ultimatefish/devil-v16-binary.XXXXXX)",
        ...
        "\"$binary_sha\"",
        "printf '%s\\n' DEVIL_V16_BINARY_PRESERVED sha256=\"$binary_sha\" "
