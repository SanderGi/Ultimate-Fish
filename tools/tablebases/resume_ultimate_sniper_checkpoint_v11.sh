...
exec >>"${log}" 2>&1
echo "sniper_ghost_same_resume_v11 checkpoint_archive_sha256 2261b5bed83f0ead28e78fb68bdb4cf65d0fbbfadd89b15d465f29b5874faffc checkpoint_archive_version F9Yi0d6S4bEyr9pzHYANdZ7sDXoqNxcd binary_sha256 d067036152298e71e00fef4f620c7779dc65a8d1dcb00dc202962df994909be1 completed_iteration 7 current_slot next bdd_slot b workers 16 max_nodes 1000000000 unique_slots 1073741824"
cd "${root}"
common=(
  --orientation same
...
echo 'sniper_ghost_same_resume_v11 complete 1'
