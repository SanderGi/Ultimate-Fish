...
BUILD_SOURCES = (
    "src/ultimate/tablebases/double_jester_information_capture.cpp",
...
def stage_source_bundle(work_directory: Path, model: str) -> Path:
    ...
    runner_target = bundle / "tools/tablebases/run_double_jester_information_capture.py"
...
def archive_file_maps(work: Path) -> tuple[dict[str, Path], dict[str, Path]]:
    ...
    common["sources/tools/tablebases/run_double_jester_information_capture.py"] = (
        work / "bundle/tools/tablebases/run_double_jester_information_capture.py")
    raw = dict(common)
