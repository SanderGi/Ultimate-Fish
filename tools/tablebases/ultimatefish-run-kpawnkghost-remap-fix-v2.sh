...
runner=/mnt/ultimatefish/info-remap-fix-v2/run_ultimate_ghost_ordinary_aws-422de069.py
work=/mnt/ultimatefish/info-remap-fix-v2/kpawnkghost-fresh-v2
...
test "$(sha256sum "${runner}" | cut -d ' ' -f 1)" = 422de069d68905ecaf47f8ec9a26f43699b75987a1ea159bc00ef792ea8fa47a
...
exec /usr/bin/python3 "${runner}" \
  ...
  --model-sha256 c3c2a566f398e551e8e948a24648c08f87e635676d263f3ba8e27cf64dee7d85 \
