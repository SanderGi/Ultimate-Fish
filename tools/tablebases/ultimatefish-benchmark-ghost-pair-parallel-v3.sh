...
readonly work=/mnt/ultimatefish/ghost-pair-parallel-v3-benchmark
readonly binary=/mnt/ultimatefish/ghost-pair-parallel-v3-f4b99f10/ultimate_ghost_pair_information_tablebase-parallel-v3
readonly transitions="${job}/work/transitions/kghostghostk"

test ! -e "${work}"
install -d -m 0755 "${work}"
test "$(sha256sum "${binary}" | cut -d ' ' -f 1)" = \
  82a23c2155f3e6b7452de69dbe150e13251a86f75caf180ec82e24f3ade3f952
