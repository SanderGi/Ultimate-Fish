#!/usr/bin/env bash
# Rebuild Pawn/Ghost transitions from an empty tree after the retained v4
# payload failed current move regeneration outside the padding domain.
set -euo pipefail
...
work=/mnt/ultimatefish/info-substate-corrected-v1/kpawnghostk-fresh-v10
...
exec python3 "${runner}" \
  ...
  --prebuilt-executable-sha256 f98c9fa41ae87647133e6a94d5deaf7f46bae038a0fa35dc60071856589daa46 \
  --prebuilt-model-sha256 51da0899d0860fc6c805b4e13a0551e3cd4a2dc5329ed99a18b34c3b090ac594 \
  --parallelism 2 \
  --transitions-only
