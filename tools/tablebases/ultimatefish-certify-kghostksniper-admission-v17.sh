...
readonly output=work/results/kghostksniper-admission-v17.ufiw
readonly arbitrary=work/results/kghostksniper-admission-v17.ufgd
readonly log=${root}/work/logs/admission-certify-v17.log
...
exec >>"${log}" 2>&1
echo 'sniper_ghost_opposed_admission_v17 completed_iteration 69 current_slot next bdd_slot a resume_converged 1 workers 32 vertical_color_remap 1 root_admission 1'
common=(
...
echo 'sniper_ghost_opposed_admission_v17 complete 1'
