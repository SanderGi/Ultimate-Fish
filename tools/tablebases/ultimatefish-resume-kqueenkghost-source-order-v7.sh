...
output=work/results/kqueenkghost-source-order-v7.ufiw
arbitrary=work/results/kqueenkghost-source-order-v7.ufgd
log=${root}/work/logs/solve-source-order-v7.log
failed_log=${root}/work/logs/solve.log
checkpoint_manifest=${root}/work/queen-v6-iteration2-current.sha256
...

{
  ...
  echo 'queen_ghost_opposed_source_order_v7 complete 1'
} >>"${log}" 2>&1
