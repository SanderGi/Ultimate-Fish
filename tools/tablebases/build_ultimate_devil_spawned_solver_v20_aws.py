#!/usr/bin/env python3
"""Build, preserve, and restore-check the phase-advised Devil v20 binary."""
...
def build(instance: str) -> str:
    ...
    commands = [
        ...
        "reverse_test=$(mktemp -d /mnt/ultimatefish/devil-v20-reverse.XXXXXX)",
        "migration_test=$(mktemp -d /mnt/ultimatefish/devil-v20-migrate.XXXXXX)",
        ...
        "binary_key=sources/binaries/devil-spawned-solver-v20/sha256/"
        "$binary_sha/ultimate_tablebase-devil-spawned-v20",
        ...
        "restore=$(mktemp /mnt/ultimatefish/devil-v20-binary.XXXXXX)",
        ...
        "\"$binary_sha\"",
        "printf '%s\\n' DEVIL_V20_BINARY_PRESERVED sha256=\"$binary_sha\" "
