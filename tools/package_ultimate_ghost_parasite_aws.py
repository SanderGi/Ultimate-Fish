...
BUILD_INPUTS_COMMON = (
    "src/ultimate/ghost_parasite_information_tablebase.cpp",
    "src/ultimate/ghost_parasite_information_solver.cpp",
    "src/ultimate/ghost_parasite_information_solver.h",
